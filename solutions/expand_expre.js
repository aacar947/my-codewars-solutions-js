...
console.log(expand("(45x-6)^5"), '184528125x^5-123018750x^4+32805000x^3-4374000x^2+291600x-7776');
console.log(expand("(-n-12)^5"), "-n^5-60n^4-1440n^3-17280n^2-103680n-248832");